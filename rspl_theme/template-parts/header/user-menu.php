...
if ( !is_user_logged_in() ) {
  ...
  <div class="user-menu__wrap">
    ...
    <a href="#" class="user-menu-login__link"></a>
  </div>
<?php }
else {
      ...
      <span class="user-menu__name"><?php echo $current_user->display_name ?></span>
          ...
          <ul class="user-menu__list">
            ...
            <li class="user-menu__item">
              <a href="<?php echo home_url( 'my-courses' ) ?>" class="user-menu__link">
            ...
            <li class="user-menu__item">
              <a href="<?php echo esc_url( wp_logout_url( home_url( '/katalog-produktov' ) ) ) ?>" class="user-menu__link user-menu__link user-menu__logout">
